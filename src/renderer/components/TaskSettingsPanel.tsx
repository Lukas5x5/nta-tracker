    ...
    switch (activeTab) {
      case 'einheiten':
        ...
        const segmentedRow = (label: string, options: { key: string; label: string }[], currentValue: string, onChange: (key: string) => void) => (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
            <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>{label}</span>
            <div style={{ display: 'flex', gap: '6px' }}>
              {options.map(opt => (
                <button key={opt.key} onClick={() => onChange(opt.key)} style={{
                  ...
                  borderRadius: '20px',
                  background: currentValue === opt.key ? 'rgba(59,130,246,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
                  color: currentValue === opt.key ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
        ...
        return (
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>QNH</span>
                  ...
                  <>
                    <input type="number" min="900" max="1100" step="1" value={settings.qnh || 1013}
                      ...
                      style={{
                        ...
                        background: 'rgba(59,130,246,0.1)', color: o.textColor,
                        fontSize: '13px', fontWeight: 600, textAlign: 'center', outline: 'none'
                      }} />
                    <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.5)` }}>hPa</span>
                  </>
                ) : (
                  <>
                    <span style={{
                      padding: '7px 16px', fontSize: '13px', fontWeight: 600,
                      background: `rgba(${o.c},${o.c},${o.c},0.08)`, borderRadius: '20px', color: `rgba(${o.c},${o.c},${o.c},0.7)`
            ...
            <div style={{ marginTop: '20px', paddingTop: '12px' }}>
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.35)`, marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Zeit</div>
            ...
            {/* Wind Section */}
            <div style={{ marginTop: '20px', paddingTop: '12px' }}>
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.35)`, marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Wind</div>
        ...
        return (
          <div>
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Pilotname</div>
              <input type="text" value={settings.pilotName || ''}
                onChange={e => updateLocalSettings({ pilotName: e.target.value })}
                placeholder="Dein Name"
                style={{ width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)', color: o.textColor, fontSize: '14px', boxSizing: 'border-box' }} />
            </div>

            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Ballon ID</div>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>BLS Sensor</div>
              ...
              {settings.lastConnectedBLSName ? (
                <div style={{ padding: '12px', background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: '8px' }}>
                  ...
                  <div style={{ fontSize: '14px', color: o.textColor, marginTop: '4px' }}>{settings.lastConnectedBLSName}</div>
                ...
                <div style={{ padding: '12px', background: `rgba(${o.c},${o.c},${o.c},0.05)`, borderRadius: '8px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, fontSize: '12px' }}>
      ...
      case 'gas':
        const gasInputStyle: React.CSSProperties = {
          ...
          border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)',
          color: o.textColor, fontSize: '13px', boxSizing: 'border-box'
        }
        return (
          <div>
            {/* Reserve-Zeit */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Reservezeit (Minuten)</div>
              <input
              ...
              />
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.35)`, marginTop: '4px' }}>
                Wird von der Restzeit abgezogen
              </div>
            </div>

            <div style={{ borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)', paddingTop: '16px' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>Gasflaschen</div>

              {(settings.gasBottles || []).map((bottle, idx) => (
                <div key={bottle.id} style={{
                  padding: '12px', borderRadius: '10px', marginBottom: '8px',
                  background: `rgba(${o.c},${o.c},${o.c},0.04)`, border: '1px solid rgba(${o.c},${o.c},${o.c},0.1)'
                }}>
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '4px' }}>Gesamtliter</div>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '4px' }}>Verbrauch (L/h)</div>
              ...
              <button
                ...
                style={{
                  ...
                  background: `rgba(${o.c},${o.c},${o.c},0.04)`, border: '1px dashed rgba(${o.c},${o.c},${o.c},0.2)',
                  color: `rgba(${o.c},${o.c},${o.c},0.6)`, fontSize: '13px', fontWeight: 600
                }}
      ...
      case 'ftasten':
        return (
          <div>
            <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '12px' }}>
              ...
              {Array.from({ length: 12 }, (_, i) => {
                ...
                return (
                  <div key={key} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{
                      fontSize: '13px', fontWeight: 700, color: currentAction !== 'none' ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.6)`,
                    ...
                    <select
                      ...
                      style={{
                        ...
                        background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)',
                        color: o.textColor, fontSize: '12px', cursor: 'pointer'
                      }}
                    >
                      {(Object.entries(FKEY_ACTION_LABELS) as [FKeyAction, string][]).map(([action, label]) => (
                        <option key={action} value={action} style={{ background: '#1a1a2e', color: o.textColor }}>
                          {label}
                        </option>
                      ))}
                    </select>
      ...
      case 'koordinaten':
        ...
        const coordBtn = (active: boolean): React.CSSProperties => ({
          padding: '7px 16px', fontSize: '12px', fontWeight: 600, border: 'none', cursor: 'pointer',
          borderRadius: '20px',
          background: active ? 'rgba(59,130,246,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
          color: active ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
          transition: 'all 0.2s ease',
        ...
        return (
          <div>
            {/* Koordinatenformat */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)` }}>Format</span>
              <div style={{ display: 'flex', gap: '6px' }}>
                {[
            ...
            {/* UTM Format */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)` }}>UTM</span>
            ...
            {/* MGRS Format */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)` }}>MGRS</span>
              <div style={{ display: 'flex', gap: '6px' }}>
                {[
                  { key: 'mgrs4', label: '4/4' },
            ...
            {/* UTM Zone Section */}
            <div style={{ marginTop: '20px', paddingTop: '12px' }}>
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.35)`, marginBottom: '12px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>UTM Zone</div>

              {/* Zone */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
                <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)` }}>Zone</span>
                <select
                  ...
                  style={{
                    ...
                    background: `rgba(${o.c},${o.c},${o.c},0.08)`, color: o.textColor,
                    fontSize: '13px', fontWeight: 600, cursor: 'pointer', outline: 'none'
                  }}
                >
                  {Array.from({ length: 60 }, (_, i) => i + 1).map(zone => (
                    <option key={zone} value={zone} style={{ background: '#1e293b', color: o.textColor }}>{zone}</option>
                  ))}
                </select>
              </div>
              ...
              {/* Band */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
                <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)` }}>Band</span>
                <select
                ...
                >
                  {['C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X'].map(band => (
                    <option key={band} value={band} style={{ background: '#1e293b', color: o.textColor }}>{band}</option>
                  ))}
                </select>
              </div>
      ...
      case 'mma':
        return (
          <div>
            {/* Standard Radius */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>
                Standard Radius (m)
              </div>
              <input type="number" min="1" max="200" step="1" value={settings.defaultMmaRadius || 100}
                ...
                style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)', color: '#f59e0b', fontSize: '14px', fontWeight: 600, textAlign: 'center', boxSizing: 'border-box' }} />
            </div>

            {/* Linienfarbe */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>Linienfarbe</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <label style={{
                  width: '50px', height: '50px', borderRadius: '50%',
                  background: settings.defaultMmaLineColor || '#ffffff',
                  border: '3px solid rgba(${o.c},${o.c},${o.c},0.3)',
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '4px' }}>Individuell wählbar</div>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.defaultMmaLineColor || '#ffffff').toUpperCase()}</div>
                </div>
              </div>
            </div>
            ...
            {/* Linienstil */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>Linienstil</div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <button onClick={() => updateLocalSettings({ mmaBorderDashed: false })} style={{
                  flex: 1, padding: '10px', fontSize: '12px', fontWeight: 600,
                  background: !settings.mmaBorderDashed ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                  color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                }}>
                  Durchgezogen
                </button>
            ...
            {/* Füllung */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>Füllung</div>
              <div style={{ display: 'flex', gap: '6px' }}>
                <button onClick={() => updateLocalSettings({ mmaFillEnabled: false })} style={{
                  flex: 1, padding: '10px', fontSize: '12px', fontWeight: 600,
                  background: !settings.mmaFillEnabled ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                  color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                }}>
                  Ohne
                </button>
            ...
            {settings.mmaFillEnabled && (
              <>
                <div style={{ marginBottom: '20px' }}>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>Füllmodus</div>
                  <div style={{ display: 'flex', gap: '6px' }}>
                    <button onClick={() => updateLocalSettings({ mmaFillDashed: false })} style={{
                      flex: 1, padding: '10px', fontSize: '12px', fontWeight: 600,
                      background: !settings.mmaFillDashed ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                      color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                    }}>
                      Gefüllt
                    </button>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textTransform: 'uppercase' }}>Füllfarbe</div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <label style={{
                      width: '50px', height: '50px', borderRadius: '50%',
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '4px' }}>Individuell wählbar</div>
                      <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.defaultMmaFillColor || '#ffffff').toUpperCase()}</div>
                    </div>
                  </div>
                </div>
              </>
            ...
            <div style={{ padding: '20px', background: 'rgba(0,0,0,0.3)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="120" height="120" style={{ overflow: 'visible' }}>
                ...
                <text x="60" y="85" fill="rgba(${o.c},${o.c},${o.c},0.5)" fontSize="10" textAnchor="middle">{settings.defaultMmaRadius || 100}m</text>
              </svg>
            </div>
          </div>
        )
      ...
      case 'utm':
        const utmToggleRow = (label: string, checked: boolean, onChange: (checked: boolean) => void) => (
          <div style={{
            ...
            padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)'
          }}>
            <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>{label}</span>
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                borderRadius: '20px',
                background: checked ? 'rgba(34,197,94,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
                color: checked ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
                transition: 'all 0.2s ease',
        ...
        const utmGridSizeRow = () => (
          <div style={{ padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Grid-Größe</span>
            ...
            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
              {[50, 100, 200, 500, 1000, 2000].map(size => (
                <button key={size} onClick={() => updateLocalSettings({ gridSize: size })} style={{
                  ...
                  cursor: 'pointer',
                  borderRadius: '20px',
                  background: settings.gridSize === size ? 'rgba(59,130,246,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
                  color: settings.gridSize === size ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
                  transition: 'all 0.2s ease',
          ...
          <div style={{ padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
            ...
            <input
              ...
              style={{
                ...
                height: '6px',
                borderRadius: '3px',
                background: `linear-gradient(to right, rgba(59,130,246,1) 0%, rgba(59,130,246,1) ${((value - min) / (max - min)) * 100}%, rgba(${o.c},${o.c},${o.c},0.1) ${((value - min) / (max - min)) * 100}%, rgba(${o.c},${o.c},${o.c},0.1) 100%)`,
        ...
        const utmColorRow = () => (
          <div style={{ padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
              <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Grid Farbe</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <label style={{
                width: '50px',
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '4px' }}>Individuell wählbar</div>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.gridLineColor || '#3b82f6').toUpperCase()}</div>
              </div>
            </div>
          </div>
        )
            ...
            {settings.showGrid && (
              <>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, textTransform: 'uppercase', letterSpacing: '1px' }}>Vorschau</span>
                  <svg width="120" height="120" style={{ overflow: 'visible' }}>
                    {/* Grid lines */}
                    {[0, 40, 80, 120].map(pos => (
                      <g key={pos}>
      ...
      case 'navigation':
        return (
          <div>
            <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '16px' }}>
            ...
            <label style={{
              ...
              background: settings.navLineEnabled !== false ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              ...
              <span style={{ fontSize: '12px', color: o.textColor }}>Navigationslinie anzeigen</span>
            </label>
            ...
            {settings.navLineEnabled !== false && (
              <>
                ...
                <div style={{ marginBottom: '16px' }}>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Linienfarbe</div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <label style={{
                      width: '50px',
                      height: '50px',
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '4px' }}>Individuell wählbar</div>
                      <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.navLineColor || '#22c55e').toUpperCase()}</div>
                    </div>
                  </div>
                </div>
                ...
                <label style={{
                  display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                  background: settings.navLineShowCourse ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                  ...
                  <input type="checkbox" checked={settings.navLineShowCourse || false}
                    ...
                    style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                  <span style={{ fontSize: '12px', color: o.textColor }}>Kurs entlang der Linie anzeigen</span>
                </label>
      ...
      case 'taskrings':
        return (
          <div>
            ...
            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.showTaskRings !== false ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer', marginBottom: '16px',
              ...
              <input type="checkbox" checked={settings.showTaskRings !== false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Task Rings anzeigen</span>
            </label>
            ...
            {settings.showTaskRings !== false && (
              <>
                {/* Ring Farben */}
                <div style={{ marginBottom: '16px' }}>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Ring Farben (4 Ringe)</div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '6px' }}>
                    {(settings.ringColors || ['#ef4444', '#f59e0b', '#3b82f6', '#22c55e']).map((color, idx) => (
                      <div key={idx}>
                        <div style={{ fontSize: '9px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginBottom: '4px', textAlign: 'center' }}>{idx + 1}</div>
                ...
                <label style={{
                  display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                  background: settings.ringDashed !== false ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                  ...
                  <input type="checkbox" checked={settings.ringDashed !== false}
                    ...
                    style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                  <span style={{ fontSize: '12px', color: o.textColor }}>Gestrichelte Linien</span>
                </label>
      ...
      case 'kurslinien':
        return (
          <div>
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Linienfarben (3 Linien)</div>
              <div style={{ display: 'flex', gap: '8px' }}>
                {[0, 1, 2].map(idx => (
                  <div key={idx} style={{ flex: 1 }}>
                    <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginBottom: '4px', textAlign: 'center' }}>Linie {idx + 1}</div>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>Kurs-Badge</div>
              ...
              <label style={{
                display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                background: settings.courseDisplayBold !== false ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
                ...
                <input type="checkbox" checked={settings.courseDisplayBold !== false}
                  ...
                  style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                <span style={{ fontSize: '12px', color: o.textColor }}>Fett</span>
              </label>

              <div>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Textfarbe</div>
        ...
        return (
          <div>
            ...
            <div style={{ padding: '16px', background: 'rgba(0,0,0,0.3)', borderRadius: '8px', marginTop: '16px' }}>
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px', textAlign: 'center' }}>Vorschau</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'center' }}>
                {(settings.windLineColors || ['#00bcd4', '#ff6b6b', '#ffd93d']).map((color, idx) => (
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.5)` }}>{['Niedrig', 'Mittel', 'Hoch'][idx]}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      case 'ballon':
        ...
        return (
          <div>
            {/* Icon Stil - Visuell */}
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '12px' }}>Icon Stil</div>
                ...
                {markerIcons.map(({ key, label, path }) => (
                  <button
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      gap: '6px',
                      background: (settings.balloonMarkerIcon || 'arrow') === key ? 'rgba(59,130,246,0.3)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                  ...
                  >
                    ...
                    <span style={{ fontSize: '9px', color: (settings.balloonMarkerIcon || 'arrow') === key ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)` }}>{label}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            {/* Größe */}
            <div style={{ marginBottom: '16px', padding: '14px 0', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Größe</span>
              </div>
              <div style={{ display: 'flex', gap: '6px' }}>
                {[
                  ...
                  <button key={key} onClick={() => updateLocalSettings({ balloonMarkerSize: key as any })} style={{
                    ...
                    cursor: 'pointer',
                    borderRadius: '20px',
                    background: (settings.balloonMarkerSize || 'medium') === key ? 'rgba(59,130,246,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
                    color: (settings.balloonMarkerSize || 'medium') === key ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
                    transition: 'all 0.2s ease',
            ...
            <div style={{ marginBottom: '16px', padding: '14px 0', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Marker Farbe</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <label style={{
                  width: '50px',
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '4px' }}>Individuell wählbar</div>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.balloonMarkerColor || '#ef4444').toUpperCase()}</div>
                </div>
              </div>
            </div>

            {/* Heading Linie */}
            <div style={{ marginTop: '8px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>Heading Linie</div>

              <div style={{
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)'
              }}>
                <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Anzeigen</span>
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    borderRadius: '20px',
                    background: settings.balloonHeadingLine ? 'rgba(34,197,94,1)' : `rgba(${o.c},${o.c},${o.c},0.08)`,
                    color: settings.balloonHeadingLine ? '#fff' : `rgba(${o.c},${o.c},${o.c},0.5)`,
                    transition: 'all 0.2s ease',
              ...
              {settings.balloonHeadingLine && (
                <>
                  <div style={{ padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                      <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Linienfarbe</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <label style={{
                        width: '40px',
                        ...
                        border: '2px solid rgba(${o.c},${o.c},${o.c},0.3)',
                        cursor: 'pointer',
                      ...
                      <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, fontFamily: 'monospace' }}>{(settings.balloonHeadingLineColor || '#ffffff').toUpperCase()}</div>
                    </div>
                  </div>

                  <div style={{ padding: '14px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                      <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Länge</span>
                      <span style={{
                        fontSize: '12px',
                        fontWeight: 600,
                        color: '#fff',
                  ...
                  <div style={{ padding: '14px 0' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                      <span style={{ fontSize: '13px', color: `rgba(${o.c},${o.c},${o.c},0.85)`, fontWeight: 400 }}>Breite</span>
                      <span style={{
                        fontSize: '12px',
                        fontWeight: 600,
                        color: '#fff',
      ...
      case 'farben':
        return (
          <div>
            ...
            <div style={{ marginBottom: '20px' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '8px', fontWeight: 600 }}>Task Marker Palette (8 Farben)</div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                {(settings.taskMarkerColors || ['#3b82f6', '#ef4444', '#22c55e', '#f59e0b', '#ec4899', '#a855f7', '#14b8a6', '#64748b']).map((color, idx) => (
                  <div key={idx} style={{ position: 'relative' }}>
                    ...
                    <input type="color" value={color}
                      ...
                      style={{ width: '100%', height: '36px', borderRadius: '6px', border: '2px solid rgba(${o.c},${o.c},${o.c},0.2)', cursor: 'pointer' }} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{ marginTop: '16px', padding: '12px', background: 'rgba(59,130,246,0.1)', borderRadius: '8px', border: '1px solid rgba(59,130,246,0.2)' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.6)`, lineHeight: '1.5' }}>
                <strong style={{ color: `rgba(${o.c},${o.c},${o.c},0.8)` }}>Weitere Farbeinstellungen:</strong><br/>
      ...
      case 'sperrgebiete':
        return (
          <div>
            ...
            {/* PZ Kreis Farbe */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>PZ Kreisfarbe</div>
            ...
            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.pzCircleDashed !== false ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer', marginBottom: '16px',
              ...
              <input type="checkbox" checked={settings.pzCircleDashed !== false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Gestrichelte Kreise</span>
            </label>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '6px' }}>Textfarbe</div>
                  <input type="color" value={settings.pzLabelColor || '#ffffff'}
                    onChange={e => updateLocalSettings({ pzLabelColor: e.target.value })}
                    style={{ width: '100%', height: '32px', borderRadius: '6px', border: 'none', cursor: 'pointer' }} />
                </div>
                <div>
                  <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '6px' }}>Hintergrund</div>
            ...
            {/* Höheneinheit */}
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Höhenanzeige</div>
              <div style={{ display: 'flex', gap: '6px' }}>
                {(['feet', 'meters'] as const).map(unit => (
                  <button key={unit} onClick={() => updateLocalSettings({ pzAltitudeUnit: unit })} style={{
                    flex: 1, padding: '10px', fontSize: '12px', fontWeight: 600,
                    background: (settings.pzAltitudeUnit || 'feet') === unit ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                    color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                  }}>
      ...
      case 'uigroesse':
        const uiStepperRow = (label: string, value: number, min: number, max: number, step: number, displayFn: (v: number) => string, onChange: (val: number) => void) => (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 0', borderBottom: '1px solid rgba(${o.c},${o.c},${o.c},0.06)' }}>
            <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)` }}>{label}</span>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <button onClick={() => onChange(Math.max(min, +(value - step).toFixed(2)))} style={{
                ...
                background: value <= min ? `rgba(${o.c},${o.c},${o.c},0.03)` : `rgba(${o.c},${o.c},${o.c},0.1)`, color: value <= min ? `rgba(${o.c},${o.c},${o.c},0.2)` : '#fff',
              ...
              <button onClick={() => onChange(Math.min(max, +(value + step).toFixed(2)))} style={{
                ...
                background: value >= max ? `rgba(${o.c},${o.c},${o.c},0.03)` : `rgba(${o.c},${o.c},${o.c},0.1)`, color: value >= max ? `rgba(${o.c},${o.c},${o.c},0.2)` : '#fff',
                fontSize: '16px', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center'
              }}>+</button>
            </div>
          </div>
        ...
        return (
          <div>
            ...
            {/* Panel Skalierungen */}
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '8px', fontWeight: 600 }}>Panel Skalierung</div>
      ...
      case 'taskicon':
        return (
          <div>
            ...
            {/* Kreuz Farbe */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Kreuz Farbe</div>
      ...
      case 'tasklabel':
        return (
          <div>
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Präfix</div>
              <input type="text" value={settings.taskLabelPrefix ?? 'Task'}
                ...
                style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)', color: o.textColor, fontSize: '12px', boxSizing: 'border-box' }} />
            </div>
            ...
            {/* Logger Badge LM */}
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>Logger Marker (LM)</div>

              <div style={{ marginBottom: '16px' }}>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>LM Präfix</div>
              ...
              <div style={{ marginBottom: '16px' }}>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>LM Badge Farbe</div>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  <input type="color" value={settings.loggerBadgeColor || '#10b981'}
                    ...
                    style={{ width: '40px', height: '40px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.3)', cursor: 'pointer', background: 'none', padding: 0 }} />
                  <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, fontFamily: 'monospace' }}>{settings.loggerBadgeColor || '#10b981'}</span>
                </div>
              </div>

              <div style={{ marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <span style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)` }}>LM Badge Größe</span>
                  <span style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, fontWeight: 600 }}>{settings.loggerBadgeFontSize || 11}px</span>
                </div>
            ...
            {/* Logger Goal (LG) */}
            <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, marginBottom: '12px', fontWeight: 600 }}>Logger Goal (LG)</div>

              <div style={{ marginBottom: '16px' }}>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>LG Präfix</div>
              ...
              <div style={{ marginBottom: '16px' }}>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>LG Badge Farbe</div>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  <input type="color" value={settings.loggerGoalBadgeColor || '#f59e0b'}
                    ...
                    style={{ width: '40px', height: '40px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.3)', cursor: 'pointer', background: 'none', padding: 0 }} />
                  <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, fontFamily: 'monospace' }}>{settings.loggerGoalBadgeColor || '#f59e0b'}</span>
                </div>
              </div>

              <div style={{ marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <span style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)` }}>LG Badge Größe</span>
                  <span style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, fontWeight: 600 }}>{settings.loggerGoalBadgeFontSize || 11}px</span>
                </div>
            ...
            <div style={{ padding: '16px', background: 'rgba(0,0,0,0.3)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginTop: '16px', flexWrap: 'wrap' }}>
              <div style={{
                background: '#3b82f6', color: o.textColor,
              ...
              <div style={{
                background: settings.loggerBadgeColor || '#10b981', color: o.textColor,
              ...
              <div style={{
                background: settings.loggerGoalBadgeColor || '#f59e0b', color: o.textColor,
        ...
        return (
          <div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                {['time', 'distance'].map(mode => (
                  <button key={mode} onClick={() => updateLocalSettings({ trackRecordingMode: mode as 'time' | 'distance' })} style={{
                    ...
                    background: settings.trackRecordingMode === mode ? '#3b82f6' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                    color: o.textColor, border: settings.trackRecordingMode === mode ? '2px solid #60a5fa' : '1px solid rgba(${o.c},${o.c},${o.c},0.2)',
                    borderRadius: '8px', cursor: 'pointer'
                  }}>
              ...
              <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginTop: '8px', fontStyle: 'italic' }}>
            ...
            {/* Track Line */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Track Linie</div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div>
                  <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginBottom: '6px' }}>Farbe</div>
                  <input type="color" value={settings.trackLineColor || '#1a73e8'}
                    onChange={e => updateLocalSettings({ trackLineColor: e.target.value })}
                    style={{ width: '100%', height: '36px', borderRadius: '6px', border: 'none', cursor: 'pointer' }} />
                </div>
                <div>
                  <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginBottom: '6px' }}>Dicke: {settings.trackLineWidth || 3}px</div>
            ...
            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.trackPointMarkers ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer',
              ...
              <input type="checkbox" checked={settings.trackPointMarkers || false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Trackpunkte als Marker anzeigen</span>
            </label>
      ...
      case 'audio':
        return (
          <div>
            ...
            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.audioAlerts ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
              ...
              <input type="checkbox" checked={settings.audioAlerts || false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Audio-Benachrichtigungen</span>
            </label>
            ...
            <div style={{ marginBottom: '20px', padding: '12px', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
              <label style={{
                ...
                <input type="checkbox" checked={settings.variometerAudio || false}
                  ...
                  style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={settings.variometerAudio ? '#22c55e' : `rgba(${o.c},${o.c},${o.c},0.5)`} strokeWidth="2">
                    <path d="M12 19V5M5 12l7-7 7 7"/>
                  </svg>
                  <span style={{ fontSize: '12px', color: o.textColor, fontWeight: 500 }}>Variometer Audio</span>
                </div>
              </label>
              ...
              {settings.variometerAudio && (
                <>
                  ...
                  <div style={{ marginBottom: '14px' }}>
                    <div style={{ fontSize: '10px', color: `rgba(${o.c},${o.c},${o.c},0.4)`, marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                  ...
                  <div style={{ marginBottom: '14px', padding: '10px', background: 'rgba(34,197,94,0.1)', borderRadius: '6px', border: '1px solid rgba(34,197,94,0.2)' }}>
                    ...
                    <input type="range" min="0" max="10" step="0.1" value={settings.variometerClimbThreshold ?? 0.3}
                      ...
                      style={{ width: '100%', cursor: 'pointer' }} />
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '9px', color: `rgba(${o.c},${o.c},${o.c},0.3)`, marginTop: '2px' }}>
                      <span>0</span>
                      <span>10 m/s</span>
                    </div>
                  </div>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                ...
                <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, fontWeight: 600 }}>Task Erinnerung</span>
              </div>

              {/* Erinnerungszeit */}
              <div style={{ marginBottom: '12px' }}>
                <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Erinnerungszeit vor Task-Ende</div>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  <input type="number" min="1" max="60" value={settings.taskReminderValue || 5}
                    ...
                    style={{ width: '70px', padding: '8px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)', color: '#f59e0b', fontSize: '14px', fontWeight: 600, textAlign: 'center' }} />
                  <div style={{ display: 'flex', gap: '4px' }}>
                    {(['minutes', 'seconds'] as const).map(unit => (
                      <button key={unit} onClick={() => updateLocalSettings({ taskReminderUnit: unit })} style={{
                        ...
                        background: (settings.taskReminderUnit || 'minutes') === unit ? '#f59e0b' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                        color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                      }}>
              ...
              <label style={{
                display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                background: settings.taskReminderSoundEnabled !== false ? 'rgba(245,158,11,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
                ...
                <input type="checkbox" checked={settings.taskReminderSoundEnabled !== false}
                  ...
                  style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                <span style={{ fontSize: '12px', color: o.textColor }}>Sound bei Erinnerung</span>
              </label>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                ...
                <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, fontWeight: 600 }}>PZ Warnung</span>
              </div>

              <label style={{
                display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                background: settings.pzWarningEnabled !== false ? 'rgba(239,68,68,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
                ...
                <input type="checkbox" checked={settings.pzWarningEnabled !== false}
                  ...
                  style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                <span style={{ fontSize: '12px', color: o.textColor }}>PZ Warnung aktivieren</span>
              </label>
              ...
              {settings.pzWarningEnabled !== false && (
                <>
                  ...
                  <label style={{
                    display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                    background: settings.pzWarningSoundEnabled !== false ? 'rgba(239,68,68,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                    borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
                    ...
                    <input type="checkbox" checked={settings.pzWarningSoundEnabled !== false}
                      ...
                      style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                    <span style={{ fontSize: '12px', color: o.textColor }}>Warnungston abspielen</span>
                  </label>

                  {settings.pzWarningSoundEnabled !== false && (
                    <>
                      <div style={{ marginBottom: '12px' }}>
                        <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Sound-Typ</div>
                        <div style={{ display: 'flex', gap: '6px' }}>
                          {(['alarm', 'beep'] as const).map(type => (
                            <button key={type} onClick={() => updateLocalSettings({ pzWarningSoundType: type })} style={{
                              ...
                              background: (settings.pzWarningSoundType || 'alarm') === type ? '#ef4444' : `rgba(${o.c},${o.c},${o.c},0.1)`,
                              color: o.textColor, border: 'none', borderRadius: '6px', cursor: 'pointer'
                            }}>
            ...
            <div style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                ...
                <span style={{ fontSize: '12px', color: `rgba(${o.c},${o.c},${o.c},0.7)`, fontWeight: 600 }}>Marker Drop Signal</span>
              </div>

              <label style={{
                display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
                background: settings.dropSignalSoundEnabled !== false ? 'rgba(249,115,22,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
                borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
                ...
                <input type="checkbox" checked={settings.dropSignalSoundEnabled !== false}
                  ...
                  style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
                <span style={{ fontSize: '12px', color: o.textColor }}>DROP-Signal Sound aktivieren</span>
              </label>
      ...
      case 'zeichnen':
        return (
          <div>
            ...
            {/* Füllfarbe */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Füllfarbe</div>
            ...
            {/* Mess-Farbe */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Messungs-Farbe</div>
            ...
            {/* Kreis Radius */}
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '11px', color: `rgba(${o.c},${o.c},${o.c},0.5)`, marginBottom: '8px' }}>Standard Kreisradius (m)</div>
              <input type="number" value={settings.circleRadius ?? 500}
                onChange={e => updateLocalSettings({ circleRadius: parseInt(e.target.value) || 500 })}
                style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', background: 'rgba(0,0,0,0.3)', color: '#3b82f6', fontSize: '12px', fontWeight: 600, boxSizing: 'border-box' }} />
            </div>

            {/* Grid Snapping */}
            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.circleGridSnapping ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer', marginBottom: '12px',
              ...
              <input type="checkbox" checked={settings.circleGridSnapping || false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Kreis Grid-Snapping</span>
            </label>

            <label style={{
              display: 'flex', alignItems: 'center', gap: '10px', padding: '12px',
              background: settings.lineGridSnapping ? 'rgba(59,130,246,0.15)' : `rgba(${o.c},${o.c},${o.c},0.05)`,
              borderRadius: '8px', cursor: 'pointer',
              ...
              <input type="checkbox" checked={settings.lineGridSnapping || false}
                ...
                style={{ width: '16px', height: '16px', cursor: 'pointer' }} />
              <span style={{ fontSize: '12px', color: o.textColor }}>Linien Grid-Snapping</span>
            </label>
      ...
      default:
        return <div style={{ color: `rgba(${o.c},${o.c},${o.c},0.5)` }}>Wähle eine Kategorie</div>
    }
  }
    ...
    <div style={{
      ...
      {showConfirmDialog && (
        <div style={{
          ...
          <div style={{
            background: o.panelGradient, borderRadius: '16px',
            ...
            <div style={{ fontSize: '15px', fontWeight: 700, color: o.textColor, marginBottom: '8px' }}>Änderungen speichern?</div>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              ...
              <button onClick={() => setShowConfirmDialog(false)} style={{ flex: 1, padding: '10px', background: `rgba(${o.c},${o.c},${o.c},0.1)`, border: '1px solid rgba(${o.c},${o.c},${o.c},0.2)', borderRadius: '8px', color: `rgba(${o.c},${o.c},${o.c},0.8)`, fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}>Abbrechen</button>
      ...
      <div className="task-settings-panel" style={{
        ...
        {/* ═══════════════════════════════════════════ */}
        <div style={{
          width: '220px', borderRight: '1px solid rgba(${o.c},${o.c},${o.c},0.1)',
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '8px' }}>
            {TABS.map(tab => (
              <button key={tab.key} onClick={() => setActiveTab(tab.key)} style={{
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={activeTab === tab.key ? '#f59e0b' : `rgba(${o.c},${o.c},${o.c},0.5)`} strokeWidth="2">
                  <path d={tab.icon} />
                </svg>
                <span style={{ fontSize: '12px', fontWeight: activeTab === tab.key ? 600 : 400, color: activeTab === tab.key ? '#f59e0b' : `rgba(${o.c},${o.c},${o.c},0.7)` }}>
                  {tab.label}
                </span>
              </button>
            ))}
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '16px', fontWeight: 700, color: o.textColor }}>
              {TABS.find(t => t.key === activeTab)?.label}
            </div>
            <button onClick={handleClose} style={{ background: 'none', border: 'none', color: `rgba(${o.c},${o.c},${o.c},0.5)`, cursor: 'pointer', padding: '4px' }}>
          ...
          {hasChanges && (
            <div style={{
              padding: '12px 20px', borderTop: '1px solid rgba(${o.c},${o.c},${o.c},0.1)',
